...
<div class="container">
    ...
    <div style="margin-left: 10%">
        ...
        <div class="w3-container">
            ...
            <form:form method="POST" action="${contextPath}/replenishment/to/the/user" modelAttribute="replenishmentToTheUserForm">
                <table>
                    <tr>
                        <td><form:label path="number">Enter number of card</form:label></td>
